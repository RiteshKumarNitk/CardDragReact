  ...
  return (
    <div>
      <motion.div
        ...
        className="relative w-60 h-72 rounded-[50px] bg-zinc-900/90 text-white px-8 py-9 overflow-hidden"
      >
        <FaRegFileAlt />
        ...
        <div className="footer absolute bottom-0  w-full left-0">
          ...
          {data.tag.isOpen && (
            ...
            >
              <h3 className="text-sm  font-semibold  flex justify-center items-center">
                {data.tag.tagTitle}{" "}
              </h3>
            </div>
          )}
